    ...
    <section className="w-full bg-white py-24">
      <div className="max-w-7xl 2xl:max-w-[100rem] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mt-6 mb-8">Deployless, Infraless Cloud Apps</h2>
        ...
        <div className="flex justify-center max-w-5xl 2xl:max-w-6xl mx-auto text-center mb-4">
          ...
          >
            <button
              ...
              className={`text-2xl font-semibold py-2 ${activeTab === 'deployless' ? 'text-purple-lbg' : 'text-gray-700'}`}
            >
              Deployless
            </button>
          </div>
          ...
          >
            <button
              ...
              className={`text-2xl font-semibold py-2 ${activeTab === 'nosetup' ? 'text-purple-lbg' : 'text-gray-700'}`}
            >
              No setup required
            </button>
          </div>
